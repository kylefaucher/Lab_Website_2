...
function loadPlayersPage(){
	...
	var dropdownDiv = document.getElementById("player_selector");
	for(let i = 0;i<numPlayers;i++){
		dropdownDiv.innerHTML += '<a class = "dropdown-item" href = "#" onclick = "switchPlayers(' + i + ')">' + players[i].name + '</a>'
	}
}
...
function switchPlayers(playerNum){
	...
	var numGames = parseInt(players[playerNum].games_played);

	document.getElementById("avg_p_yards").innerHTML = Math.floor(parseInt(players[playerNum].pass_yards)/numGames);
	document.getElementById("avg_r_yards").innerHTML = Math.floor(parseInt(players[playerNum].rushing_yards)/numGames);
	document.getElementById("avg_rec_yards").innerHTML = Math.floor(parseInt(players[playerNum].receiving_yards)/numGames);
}			
